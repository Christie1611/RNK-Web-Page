...
<!DOCTYPE html>
    ...
    <body id="forest" data-page="forest">
            ...
            <div class="divMenu">
                ...
                <ul class="menu">
                    ...
                    <li>
                        <a href="#">Facciones</a>
                        <ul class="submenu">
                            <li><a href="#" class="forest-link">Greats</a></li>
                    ...
                    <div class="members">
                        <div class="characterCard">
                            <div class="divCharacterImg">
                                <img id="characterImg" src="../Imagenes/Neumann.jpg" class="imgAnim" alt="">
                            </div>
                            <div class="info">
                                <h2 id="characterName" class="textPart">John V. Neumann</h2>

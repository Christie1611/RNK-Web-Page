export const factionsData = {
    forest: {
        ...
        description: `
            <p>
                ...
                los Reencarnados con Talentos de personas que dejaron una marca positiva en la historia, el motivo de su creación es
                el de la Paz Mundial. Originalmente estaba compuesta por tan solo 5 Reencarnados reúnidos en un pequeño escondite, 
                pero con el paso del tiempo, los números fueron incrementando hasta contar con miles de Reencarnados con diferentes bases
                secretas alrededor del mundo, apoyando en los campos filosóficos, históricos, literarios, artísticos, psicológicos, 
                bélicos, y un enorme etcétera.
            </p><br>

            <p>
                Además de esto, y siguiendo con las directivas de uno de los Reencarnados fundadores, Leonardo Da Vinci, se tiene
                como misión el buscar y cazar a todos los Reencarnados cuyos Talentos se especializan en hacerle el mal a la humanidad,
                los Pecadores, siendo estos el principal obstáculo que le impide al Bosque alcanzar la Paz Mundial.
            </p><br>
        `,
        spoilers: `
            <p>
                Más adelante en la historia, se revelaría que el Bosque llegó a una conclusión para cumplir su deseo. Hay demasiados
                humanos en el planeta como para manejarlos a todos, y la sola existencia de éstos implica la posibilidad de que Reencarnados
                con Talentos malvados nazcan en cualquier lugar; por lo que el Bosque de los Grandes acabará con los 7 mil millones de
                seres humanos, manteniendo a solo unos pocos para convertirlos en Reencarnados por medio de las Ramas de la Reencarnación,
                si su Talento es el de un Grande, se volverá parte del equipo, pero si es un Pecador, se le eliminará inmediatamente.
            </p><br>
    ...
    sinners: {
        ...
        description: `
            <p>
                La Reencarnación es algo que le ocurre a todos los humanos por igual, eso por definición incluye a las personas
                que cometieron todo tipo de males en sus vidas pasadas. Dictadores, terroristas, asesinos, violadores... mientras
                sigan siendo humanos, tendrán la oportunidad de regresar para volver a cometer sus crimenes. Cada Reencarnado está
                atado a su Talento, por lo que los Pecadores sienten el impulso de cometer las atrocidades que hicieron en su vida
                pasada. Es debido a esta naturaleza tan peligrosa que se tiene como alta prioridad el eliminarlos.
            </p><br>

            <p>
                Aunque no se pueden considerar una organización como tal, todos estos pecadores fueron reunidos por Kouu, uno de 
                los Reencarnados originales que fundó el Bosque de los Grandes, pero que desertó al ver que el Bosque tenía la 
                intención de eliminar a quienes consideraba sus compañeros en pos de salvar a la humanidad. La visión de Kouu siempre 
                fue el libre albedrío, dejar que los Reencarndos hagan lo que quieran con esta segunda vida, aún si eso implica que 
                los pecadores amenacen con la Paz Mundial. Habiéndole declarado la guerra al Bosque de los Grandes, los Pecadores 
                dejarán salir a la luz los Talentos que tanto les han obligado a reprimir.
            </p><br>
        `,
        spoilers: `
            <p>
                Kouu tiene el Talento de un Pecador. Ha viajado por todo el mundo y visto Reencarnados de todo tipo, por lo que 
                sabía mejor que nadie la amenaza que suponían los pecadores para las personas, pero no podía simplemente matarlos,
                eso iba en contra de sus creencias sobre la libertad, es por eso que se le ocurrió un plan. El motivo por el que le
                declaró la guerra al Bosque de los Grandes era una excusa para que todos sus compañeros murieran por igual. Si todos
                se matan entre sí en un entorno donde serán capaces de desplegar sus Talentos al máximo sin pensar en las consecuencias,
                entonces podrían estar finalmente satisfechos, y la amenaza de los Pecadores se desvanecería.
            </p><br>

            <p>
                Quizás fue demasiado inocente creyendo que un plan como este funcionaría, pero ninguno de sus compañeros se echó para
                atrás. Todos en el fondo sabían que eran peligrosos, siguen siendo humanos, y por eso aceptaron este destino con 
                una sonrisa. Kouu solo quería darles una muerte digna.
            </p>
        `,
        members: [
                    {
    ...
    strays: {
        ...
        description: `
            <p>
                No todos los Reencarnados pertenecen a una organización, algunos simplemente quieren vivir y emplear sus Talentos
                como les plazca y a su propio ritmo, algunos podrán juntarse en pequeños grupos, pero eso no se consideraría una
                asociasión como tal, solo un grupo de Reencarnados que dio la casualidad de que tenían cosas en común. 
            </p><br>

            <p>
                No obstante, a pesar de no pertenecer a ningún grupo, los Reencarnados están al tanto de todo lo que ocurre alrededor
                del mundo, esto es gracias al períodico creado por Victor Hugo, quien recopila todas las noticias con su Talento y los
                mantiene al corriente de cualquier nueva información. Fue de esta forma que muchos se enteraron de la guerra entre los
                Pecadores y el Bosque de los Grandes, aunque ninguno parecía realmente interesado en participar en esa matanza.
            </p><br>
        `,
        spoilers: `
            <p>
                Después de que el plan de extinguir a la humanidad y reemplazarla por los Reencarnados fuera anunciado por el
                Bosque de los Grandes, esto se consideró una señal para que los Reencarnados Errantes le mostraran sus Talentos
                al mundo. Si este era el fin de la humanidad, entonces los Reencarnados no tenían más motivos para seguir
                escondiéndose, lo que resultó en que muchos desplegaran sus habilidades sin pensar en el bienestar de las personas,
                lo que resultó en la muerte de muchas personas y Reencarnados por igual.
            </p><br>

            <p>
                Cuando Victor Hugo anunció la muerte de Kouu, muchos Reencarnados que éste ayudó acudieron a su funeral para llorar por
                su pérdida, sin esperarse que el final estaba más cerca de lo que pensaban. Tras la aparición de un Reencarnado llamado 
                Alexander Non Grata, se anunció la reinauguración de la "Great Men's War", un evento que en el pasado fue el causante de 
                casi extinguir a todas las especies en el planeta. Algo como esto escapaba de las capacidades de los Errantes, lo que 
                desembocó en el suicidio de muchos.
            </p><br>
            
            <p>
                Ellos querían dejar salir a relucir sus Talentos, y estas fueron las consecuencias de ello.
            </p>
        `,
        members: [
                    {
    ...
    others: {
        ...
        description: `
            <p>
                No todos los Reencarnados quieren ayudar a la humanidad, y no todos los Reencarnados quieren ponerla en peligro, por eso
                muchos decidieron crear sus propias asociasiones, no para cometer ningún bien o mal en específico, sino para construir un
                espacio donde los Reencarnados que tienen cosas en común puedan emplear sus Talentos sin molestar a nadie. Estas asociasiones
                no tienen el mismo alcance que el Bosque de los Grandes o el ejército de Pecadores, pero la cantidad de éstas es tan vasta
                que se encuentran distribuidas en todo el planeta. Técnicamente se les podría considerar como Reencarnados Errantes, pero
                dado que éstos grupos parecen tener una mejor organización, se les ha tratado como entidades diferentes.
            </p><br>

            <p>
                Algunas de las asociasiones mencionadas dentro de la historia son las siguientes:
            </p><br>
            <ul class="listFaction">
                <div>
                    <li>Asociasión del Arte</li>
                    <li>Asociasión de Música</li>
                    <li>Asociasión de Escritores</li>
                    <li>Asociasión de Matemáticos</li>
                    <li>Asociasión de Inventores</li>
                    <li>Asociasión de Medicina</li>
                    <li>Asociasión de Aviadores</li>
                </div>
                <div>
                    <li>Los Sabios</li>
                    <li>Asociasión Lumiéres</li>
                    <li>Asociasión de Espers</li>
                    <li>Asociasión de Astronomía</li>
                    <li>Asociasión de Brujería</li>
                    <li>Proyecto Stargate</li>
                    <li>Asociasión de Jack el Destripador</li>
                </div>
            </ul>
        `,
        spoilers: `
             <p>
                Algunas asociasiones decidieron unirse al Bosque de los Grandes, otras asociasiones intentaron detener sus planes,
                otras simplemente se rindieron, y otras se mantuvieron ajenas ante todo conflicto. Cada quién aborda el conflicto
                como más le parezca, lo único de lo que pueden estar seguros es que esta decisión será apoyada por todo el grupo.
            </p><br>
            
            <p>
                ¿En dónde perteneces tú?
            </p>
        `,
        members: [
                    {
                    ...
                    },
                    {
                        ...
                        talent: `<div>
                                    ...
                                    <p>
                                        ...
                                        habilidades y Talento, y no parará de perseguir a su objetivo hasta que pueda atraparlo y hundirlo en la oscuridad
                                        de la que provino.
                                    </p><br>
                                    <p>
